...
def interview():
    ...
    # --------------------------------------------------
    # IF A SUB-PAGE IS SELECTED
    # --------------------------------------------------

    if st.session_state.interview_page == "aptitude":
        aptitude.aptitude()
    ...
    elif st.session_state.interview_page == "mock":
        mock.mock()
    ...
    with col1:
        if st.button(
            ...
            st.session_state.interview_page = "aptitude"
            st.rerun()
    ...
    with col2:
        if st.button(
            ...
            st.session_state.interview_page = "technical"
            st.rerun()
    ...
    with col3:
        if st.button(
            ...
            st.session_state.interview_page = "mock"
            st.rerun()
